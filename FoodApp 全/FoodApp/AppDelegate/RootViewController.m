...
-(void)CreateChildViewController{
    ...
    [self addOneChildViewController:[[UINavigationController alloc] initWithRootViewController:SVC] Title:@"首页" Normalimage:@"noodles" SelectImg:@"noodlesH"];
    
    //视频展示
    VideoTableViewController *VideoVC = [[VideoTableViewController alloc]init];
    [self addOneChildViewController:[[UINavigationController alloc] initWithRootViewController:VideoVC]  Title:@"学做菜" Normalimage:@"video" SelectImg:@"videoH"];
