...
//               [[[UIApplication sharedApplication].delegate window] addSubview:self.playerView];
               [self.view addSubview:self.playerView];
...
- (IBAction)tapaction:(UITapGestureRecognizer *)sender {
     ...
     */
    //[[UIApplication sharedApplication]statusBarOrientation] 可以更好的获取设备的状态
...
//     make.right.mas_equalTo(self.playerView.mas_right);
...
-(void)constrainOfBottomView{
   ...
   // if([[UIApplication sharedApplication] statusBarOrientation] == [UIDevice ])
    //约束 bottomView
    [self.bottomView removeFromSuperview];
