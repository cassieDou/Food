...
- (void)creatView
{
    ...
    _myScrollView.contentSize = CGSizeMake(5*kItemWidth + 2*kItemIntreval, SHeight);
    ...
    //左边视图
    _leftView = [[UIImageView alloc] initWithFrame:CGRectMake(kItemWidth + kItemIntreval, 0, kItemWidth, SHeight)];
    _leftView.image = _imageArr[leftIndex];
    [_myScrollView addSubview:_leftView];
    
    //中心视图
    _centerView = [[UIImageView alloc] initWithFrame:CGRectMake(kItemWidth*2 + 2*kItemIntreval, 0, kItemWidth, SHeight)];
    ...
    //右边视图
    _rightView = [[UIImageView alloc] initWithFrame:CGRectMake(3*kItemWidth + 3*kItemIntreval, 0, kItemWidth, SHeight)];
